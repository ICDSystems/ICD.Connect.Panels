...
namespace ICD.Connect.Panels.CrestronPro.TriListAdapters.X60.Tsw560Nc
{
	...
	public sealed class Tsw560NcAdapter :
		AbstractTswX60BaseClassAdapter<Crestron.SimplSharpPro.UI.Tsw560Nc, Tsw560NcAdapterSettings>
	{
		/// <summary>
		...
		/// <returns></returns>
		protected override Crestron.SimplSharpPro.UI.Tsw560Nc InstantiateTriList(byte ipid,
